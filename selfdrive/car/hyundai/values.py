...
FEATURES = {
  "use_cluster_gears": # Use Cluster for Gear Selection, rather than Transmission
      set([CAR.ELANTRA, CAR.ELANTRA20, CAR.KONA, CAR.ELANTRA_I30, CAR.MOHAVE, CAR.CADENZA, CAR.NIRO_HEV, CAR.GRANDEUR, CAR.GRANDEUR20]),
  "use_tcu_gears": # Use TCU Message for Gear Selection
      set([CAR.OPTIMA, CAR.SONATA19, CAR.VELOSTER]),
  "use_elect_gears": # Use E_GEAR Message for Gear Selection
  ...
  "use_fca": set([CAR.SONATA, CAR.PALISADE, CAR.ELANTRA, CAR.ELANTRA_I30, CAR.KONA, CAR.KONA_HEV, CAR.IONIQ_HEV,
