...
def thermald_thread():
  ...
  while 1:
    ...
    startup_conditions["fw_version_match"] = (panda_signature is None) or (panda_signature == FW_SIGNATURE) or ("NOSENSOR" in os.environ)  # don't show alert is no panda is connected (None)
