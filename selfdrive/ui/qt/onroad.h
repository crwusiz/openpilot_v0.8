...
private:
  ...
  std::map<AudibleAlert, std::pair<QString, bool>> sound_map {
    ...
    {AudibleAlert::CHIME_CALIBRATION1, {"../assets/sounds/calibration1.wav", false}},
    {AudibleAlert::CHIME_CALIBRATION2, {"../assets/sounds/calibration2.wav", false}},
    {AudibleAlert::CHIME_ENGAGE2, {"../assets/sounds/engagedt.wav", false}},
    {AudibleAlert::CHIME_DISENGAGE2, {"../assets/sounds/disengagedt.wav", false}}
  };
